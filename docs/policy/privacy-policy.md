...
1.2.1 Generally, CoStrict services need to be pre-purchased before use, and users can purchase only after logging in to their accounts. During the purchase process, we will only record page response status and whether the purchase is successful through logs, without collecting other personal information from users. After the purchase is completed, users can request invoices. When users choose the invoice title as personal, they need to provide an **email address and mobile phone number** to receive electronic invoices. When users choose the invoice title as an enterprise, they must accurately provide the invoice title information and fill in an **email address** to receive electronic invoices.

1.2.2 When you communicate with the CoStrict AI programming assistant, we will automatically receive the **data you input (the instruction information and code snippets you input)** to provide you with functions such as code generation, code completion, and code Q&A. In addition to the data you actively input, to perform relevant tasks according to your instructions, we may also need to **read data within the AI programming assistant workspace you set (the folder you use to open the AI programming assistant application will be the application's workspace by default), and may need to write data to the workspace; reading data outside the workspace will also be performed strictly according to the user's permission settings, and no data outside the workspace will be read unless the user explicitly performs an action to allow it**. Because the capabilities of the AI programming assistant require support from large models, these models include both models that we have deployed locally and external third-party models that we access through APIs or other means. Some of these models may be deployed and operated outside China. Therefore, the data described above in this clause may be transmitted to external third-party servers, or even outside China, for processing during your use. Users may also choose to connect their own locally deployed models. In this case, the data described above still needs to be transmitted to our servers, but will not be transmitted to external third parties. **Please be aware and understand: Because your personal information concerns your privacy rights and interests, please ensure that the data you actively input and the data you allow us to read do not contain your personal information, so as to avoid our passively receiving and processing your personal information, or even transmitting your personal information to other third parties according to your needs and choices. For your other data, please also evaluate and confirm in advance when selecting a model whether you agree to provide the data to a third party or even transmit it outside China for processing. If you need to confirm the connection method between our application and the models available for selection, you may contact us using the contact information provided in this Policy.**

Except for the use scenarios and purposes listed in this Privacy Protection Policy and the fulfillment of legal obligations, we will not use the code files you upload and generate in any other scenario not authorized by you.
...
2.5 As described in Section 1.2.2 above, when users use the services provided by CoStrict, they may independently select the large model used to provide technical support. Depending on the user's selection, relevant data generated during use may need to be transmitted to servers on which third-party models are deployed for processing. This data will be stored where the third-party servers are located and processed in accordance with the relevant agreements between the third-party service provider and the user. For this data, Sangfor can only provide users with relevant information upon request based on the service integration circumstances, but cannot undertake to protect your data rights and interests in accordance with this Privacy Protection Policy. Therefore, please carefully conduct the necessary assessment and confirmation in advance when selecting a service.
