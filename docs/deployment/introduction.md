...
You can refer to the tutorial below to configure the model on the page. We also provide a quick model configuration script to simplify your configuration process; see [Model Configuration Automation Script](./auto-model-config.md), so you can skip this step.
