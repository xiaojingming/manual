...
> To view the deployment architecture, server requirements, model requirements, model download links, etc., please visit [Foreword](./foreword)
...
You can refer to the tutorial below to configure the model on the page. We also provide a quick model configuration script to simplify your configuration process; see [Model Configuration Automation Script](./auto-model-config).
...
Detailed configuration guide: [Higress Configuration Document](./higress)
...
Basic user setup reference: [Casdoor Basic Settings](./casdoor)
