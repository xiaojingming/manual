...
Enter `/project-wiki`, press Enter to execute, and wait for completion. Execution time ranges from a few minutes to tens of minutes, depending on the project size.
