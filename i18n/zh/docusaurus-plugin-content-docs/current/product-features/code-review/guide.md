...
![IDE使用1-扫描代码文件](./img/IDE使用1-扫描代码文件.webp)

#### 方式二：扫描代码片段

在编辑器中**选中代码片段**，**右键点击**选择 **代码审查** 即可对选中的代码进行代码扫描。

![IDE使用2-扫描代码片段](./img/IDE使用2-扫描代码片段.webp)

#### 方式三：扫描代码变更

点击左侧 **CoStrict 小图标**，切换至 **CODE REVIEW** 页面，即可扫描当前工作区的代码变更。

![IDE使用3-扫描代码变更](./img/IDE使用3-扫描代码变更.webp)
...
![IDE使用-侧边栏面板](./img/IDE使用-侧边栏面板.webp)
...
![IDE使用-完整效果](./img/IDE使用-完整效果.webp)
...
![IDE使用-审查历史](./img/IDE使用-审查历史.webp)
...
![IDE使用-处置缺陷](./img/IDE使用-处置缺陷.webp)
