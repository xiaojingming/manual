...
![IDE使用1-扫描代码文件](./img/codereview/IDE使用1-扫描代码文件.png)

##### 方式二：扫描代码片段

在编辑器中**选中代码片段**，**右键点击**选择 **代码审查** 即可对选中的代码进行代码扫描。

![IDE使用2-扫描代码片段](./img/codereview/IDE使用2-扫描代码片段.png)

##### 方式三：扫描代码变更

点击左侧 **CoStrict 小图标**，切换至 **CODE REVIEW** 页面，即可扫描当前工作区的代码变更。

![IDE使用3-扫描代码变更](./img/codereview/IDE使用3-扫描代码变更.png)
...
![IDE使用-侧边栏面板](./img/codereview/IDE使用-侧边栏面板.png)
...
![IDE使用-完整效果](./img/codereview/IDE使用-完整效果.png)
...
![IDE使用-审查历史](./img/codereview/IDE使用-审查历史.png)

##### 处置缺陷

我们鼓励用户根据实际情况点击详情卡片右上角的按钮来反馈：

- **接受**：表示你认可AI输出的问题
- **拒绝**：表示你认为这不是一个问题或者输出有误
- **关闭**：关闭当前详情窗口
