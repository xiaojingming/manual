...
> 查看此项目的部署架构，部署的服务器要求、模型要求、模型下载地址等，请访问 [前言](./foreword)
...
你可以参考下面的教程在页面上配置模型，我们也提供了快速模型配置脚本，简化你的配置过程，见[模型配置自动化脚本](./auto-model-config)
