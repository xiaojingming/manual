...
![img](img/strict-spec/select-mode.webp)

## 输入需求

可以直接输入你的需求

![img](img/strict-spec/input-requirement.webp)

## 启动流程

![img](img/strict-spec/strict-spec.webp)
...
![img](img/strict-spec/user-input-record.webp)
...
![img](img/strict-spec/requirement-clarification.webp)

切换问题推荐用左右键`←` `→`或者鼠标点击，以免用Tab误触切换了模式。每个问题选择后切换到Confirm按Enter提交

![img](img/strict-spec/submit-answer.webp)
...
![img](img/strict-spec/design-confirmation.webp)
...
![img](img/strict-spec/design.webp)
...
![img](img/strict-spec/task-planning.webp)
...
![img](img/strict-spec/task-distribution.webp)

### 进度更新

每个任务完成后，PlanManager会立即更新plan.md文件，将任务标记为已完成（`- [x]`）

![img](img/strict-spec/task-complete.webp)
...
![img](img/strict-spec/specplan-detail.webp)

### 生成提案

![img](img/strict-spec/proposal.webp)

### 生成编码任务

![img](img/strict-spec/spec-plan-task.webp)

## 编码结束

plan.md中任务全部标记完成

![img](img/strict-spec/all-complete.webp)